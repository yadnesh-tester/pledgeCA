  ...
  nav.innerHTML =
    '<div class="container nav-inner">' +
      ...
      '<ul class="nav-links" id="navLinks">' +
        ...
        '<li><a href="about-us.html"' + (activeClass('about-us.html') ? ' class="active"' : '') + '>About Us</a></li>' +
        '<li><a href="services.html"' + (activeClass('services.html') ? ' class="active"' : '') + '>Services</a></li>' +
        '<li><a href="test-series.html"' + (activeClass('test-series.html') ? ' class="active"' : '') + '>Courses</a></li>' +
        '<li><a href="contact-us.html"' + (activeClass('contact-us.html') ? ' class="active"' : '') + '>Contact</a></li>' +
  ...
  bottomBar.innerHTML =
    '<div class="mobile-bottom-bar-inner">' +
      '<a href="tel:+919764015003" class="btn-call">' +
        ...
        '</svg> Call Now' +
      '</a>' +
      '<a href="contact-us.html" class="btn btn-gold">Contact Now</a>' +
    '</div>';
