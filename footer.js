    ...
    '<div class="container">' +
      '<div class="footer-grid">' +
        '<div class="footer-brand">' +
          ...
          '</div>' +
        '</div>' +
        '<div><button class="footer-toggle" aria-expanded="false">Quick Links <span class="chevron">&#9660;</span></button><h4>Quick Links</h4><ul class="footer-links"><li><a href="index.html">Home</a></li><li><a href="about-us.html">About Us</a></li><li><a href="services.html">Services</a></li><li><a href="test-series.html">Courses</a></li></ul></div>' +
        '<div><button class="footer-toggle" aria-expanded="false">More Links <span class="chevron">&#9660;</span></button><h4>More Links</h4><ul class="footer-links"><li><a href="contact-us.html">Contact</a></li><li><a href="index.html#testimonials">Reviews &amp; Testimonials</a></li><li><a href="refund-policy.html">Refund Policy</a></li><li><a href="terms.html">Terms &amp; Conditions</a></li></ul></div>' +
